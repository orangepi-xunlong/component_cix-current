...
#else
	TILER_COUNTER_DEF("primassy_stall", 1435979, PRIMASSY_STALL),
	TILER_COUNTER_DEF("idvs_var_shad_stall", -2567546, IDVS_VAR_SHAD_STALL),

	MEMSYS_COUNTER_DEF("l2_rd_msg_in_cu", 11560866, L2_RD_MSG_IN_CU),
	MEMSYS_COUNTER_DEF("l2_snp_msg_in", -12102323, L2_SNP_MSG_IN),
	MEMSYS_COUNTER_DEF("l2_ext_read_nosnp", 3054428, L2_EXT_READ_NOSNP),
#endif
};
...
#else
	SC_COUNTER_DEF("exec_instr_fma", 232300, EXEC_INSTR_FMA),
	SC_COUNTER_DEF("exec_instr_msg", 4388931, EXEC_INSTR_MSG),
	SC_COUNTER_DEF("beats_rd_tex", 297568, BEATS_RD_TEX),
	SC_COUNTER_DEF("beats_rd_lsc_ext", 247084, BEATS_RD_LSC_EXT),
	SC_COUNTER_DEF("frag_quads_coarse", 80685, FRAG_QUADS_COARSE),
	SC_COUNTER_DEF("ls_mem_write_short", 411555, LS_MEM_WRITE_SHORT),
	SC_COUNTER_DEF("beats_rd_tex_ext", -1114831, BEATS_RD_TEX_EXT),
	SC_COUNTER_DEF("exec_instr_sfu", 2364371, EXEC_INSTR_SFU),
#endif
};
